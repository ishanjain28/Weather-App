...
const CurrentWeatherInfo = React.createClass({
    render: function()  {
        ...
        if(this.props.WeatherData)  {
            ...
            CurrentWeather.windSpeed ? Wind += CurrentWeather.windSpeed : $('.Wind').css('display', 'none');

            CurrentWeather.visibility ? Visibility = "Visibility " + CurrentWeather.visibility + "miles" : $('.Visibility').css('display', 'none');

            CurrentWeather.pressure ? Barometer = "Barometer " + CurrentWeather.pressure : $('.Barometer').css('display', 'none');

            CurrentWeather.humidity ? Humidity = "Humidity " + (CurrentWeather.humidity * 100) + "%" : $('.Humidity').css('display', 'none');

            CurrentWeather.dewPoint ? DewPoint = "Dew Point " + CurrentWeather.dewPoint : $('.DewPoint').css('display', 'none');
        }
        return (
